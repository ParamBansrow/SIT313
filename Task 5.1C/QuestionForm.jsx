...
function QuestionForm({postType}){
    return(
        <form className="ques">
            ...
            <div id="text">
                <p>Title</p>
                <input className="textBox" type="text" placeholder="Start your question with how, what, why, etc." required/>
            </div>
            
            <div>
                <p>Describe your problem</p>
                <textarea id="des" type="text" required minLength={5} maxLength={100}/>
            </div>

            <div id="tag">
                <p>Tags</p>
                <input className="textBox" type="text" placeholder="Please add up to 3 tags to describe your question e.g., Java" required/>
            </div>
